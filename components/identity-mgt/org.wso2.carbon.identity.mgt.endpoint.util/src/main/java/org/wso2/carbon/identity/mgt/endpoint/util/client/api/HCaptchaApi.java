...
import org.wso2.carbon.identity.mgt.endpoint.util.client.model.HCaptchaProperties;
...
/**
 * This class generating and invoking the Captcha api to display and the HCaptcha.
 */
public class HCaptchaApi {
    ...
    private HCaptchaApi(ApiClient apiClient) {
     ...
     * @return Return captcha details as HCaptchaProperties.
     * @throws ApiException if fails to make API call.
     */
    public HCaptchaProperties getHCaptcha(String tenantDomain, boolean isEndpointTenantAware, String captchaType,
        ...
        GenericType<HCaptchaProperties> localVarReturnType = new GenericType<HCaptchaProperties>() {
        };
